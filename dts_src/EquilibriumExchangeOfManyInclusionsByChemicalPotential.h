#ifndef EquilibriumExchangeOfManyInclusionsByChemicalPotential_H
#define EquilibriumExchangeOfManyInclusionsByChemicalPotential_H
...
/**
 * @class EquilibriumExchangeOfManyInclusionsByChemicalPotential
...
class EquilibriumExchangeOfManyInclusionsByChemicalPotential : public AbstractInclusionConversion
{
public:
    /**
     * @brief Constructor
    ...
    static inline std::string GetDefaultReadName() { return "EquilibriumExchangeOfManyInclusions"; }
