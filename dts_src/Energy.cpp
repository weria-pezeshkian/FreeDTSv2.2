...
double Energy::Interaction_6(double N, double A, double B, double C,  links* p_link){
...
double Energy::Interaction_7(double N, double A, double B, double C, double l_0,  links* p_link){
