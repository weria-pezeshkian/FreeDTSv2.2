/*
 ===============================================================
 FactoryVertexPositionIntegrator
 ===============================================================
 ...
 4. The State class calls:
        ...
        FactoryVertexPositionIntegrator::Instance()
...
class FactoryVertexPositionIntegrator {
public:
    ...
    */
    using Creator =
        std::function<AbstractVertexPositionIntegrator*(std::istream&, State*)>;
    ...
    ---------------------------------------------------------------
    */
    static FactoryVertexPositionIntegrator& Instance()
    {
        static FactoryVertexPositionIntegrator instance;
        return instance;
    }
...
private:
    ...
    FactoryVertexPositionIntegrator() = default;

    FactoryVertexPositionIntegrator(
        const FactoryVertexPositionIntegrator&) = delete;

    FactoryVertexPositionIntegrator& operator=(
        const FactoryVertexPositionIntegrator&) = delete;
