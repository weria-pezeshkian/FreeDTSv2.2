...
void InclusionPoseUpdateByMetropolisAlgorithm::MC_Move_AnInclusion(inclusion *pinc, RNG* Random, int movetype )
{
    m_LIntEChange.clear();
...
void InclusionPoseUpdateByMetropolisAlgorithm::KawasakiMove(double temp, links * d_links)
{
...
void InclusionPoseUpdateByMetropolisAlgorithm::RotationMove(double temp, double dx, double dy)
{
